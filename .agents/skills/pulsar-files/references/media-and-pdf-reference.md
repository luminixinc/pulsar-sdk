...
front-end to `createSFFileFromFilePath(Batch)` (see `references/files-api-reference.md`).
...
| Checkbox-style custom fields in create payloads | `'TRUE'`/`'FALSE'` strings (field-data convention, see AGENTS.md) |
